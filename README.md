...
1. **ログイン/アカウント作成画面**: ユーザーがログインまたはアカウントを作成するための画面

2. **プラン選択画面**: 初回ログイン時に、ユーザーが無料プランか有料プランを選択するための画面

3. **ホーム画面**: ユーザーが基本的な検索を行うための画面。有料プランのユーザーはここから高度な検索画面にアクセスできる

4. **高度な検索画面**: 有料プランのユーザーがフィルタを使用して高度な検索を行うための画面

5. **関係図表示画面**: 検索結果として表示されるエンティティ間の関係図。無料プランと有料プランのユーザーがアクセスできますが、有料プランのユーザーは拡張された範囲の関係図を見ることができる

6. **エンティティ詳細画面**: エンティティの詳細情報を表示する画面。これは有料プランのユーザーのみに利用可能

7. **カスタマイズ画面**: 有料プランのユーザーが関係図のカスタマイズを行うための画面

8. **データエクスポート画面**: 有料プランのユーザーが関係図をPDFや画像形式でエクスポートするための画面
