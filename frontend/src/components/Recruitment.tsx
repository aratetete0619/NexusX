      ...
      <div className={styles.container}>
        ...
        <div className={styles.section1}>
          <div className={styles.imageContainer}>
            <img src="/recruitment1.png" alt="recruitment1" className={styles.image1} />
          </div>
        ...
        <div className={styles.section2}>
          <div className={styles.imageContainer}>
            <img src="/recruitment2.png" alt="Image 2" className={styles.image2} />
          </div>
          <div className={styles.imageContainer}>
            <img src="/recruitment3.png" alt="Image 3" className={styles.image3} />
          </div>
        </div>
      </div>
    </Slide>
